...
--- 
title: "Advanced Linear Algebra in the AI Age: Geometry, Computation, and Data"
...
Welcome to **Advanced Linear Algebra in the AI Age: Geometry, Computation, and Data**.
...
<<<<<<< HEAD
Assume students already have some basic linear algebra knowledge, including matrix computations, solving linear systems, subspaces of $\mathbb{R}^n$, kernel and image, basis and dimension. Another linear algebra book without prerequisites is here: [Linear Algebra Language in the AI Age](https://wanghemath.github.io/MATH5110Book/).
=======
Assume students already have some basic linear algebra knowledge, including matrix computations, solving linear systems, subspaces of $\mathbb{R}^n$, kernel and image, basis and dimension. Another linear algebra book without prerequisites is here: [Linear Algebra Language in the AI Age](https://wanghemath.github.io/Book-LinearAlgebraLanguage/).
>>>>>>> 7bef99f (Update book)

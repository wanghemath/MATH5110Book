...
Assume students already have some basic linear algebra knowledge, including matrix computations, solving linear systems, subspaces of $\mathbb{R}^n$, kernel and image, basis and dimension. Another linear algebra book without prerequisites is here: [Linear Algebra Language in the AI Age](https://github.com/wanghemath/Book-LinearAlgebraLanguage). 
...
**Course Website:** [MATH 5110 Course Website](https://wanghemath.github.io/Book-AdvancedLinearAlgebraAI)  

...
**Book website:** [https://wanghemath.github.io/Book-AdvancedLinearAlgebraAI/](https://wanghemath.github.io/Book-AdvancedLinearAlgebraAI/)
...
```bash
git clone https://github.com/wanghemath/Book-AdvancedLinearAlgebraAI.git
cd Book-AdvancedLinearAlgebraAI
```
...
```bash
https://github.com/wanghemath/Book-AdvancedLinearAlgebraAI.git
```
...
[https://wanghemath.github.io/Book-AdvancedLinearAlgebraAI/](https://wanghemath.github.io/Book-AdvancedLinearAlgebraAI/)

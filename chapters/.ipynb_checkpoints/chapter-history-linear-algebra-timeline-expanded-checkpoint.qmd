---
title: "Chapter: A Historical Timeline of Linear Algebra"
subtitle: "People, Problems, Ideas, Algorithms, and Applications"
author: "He Wang"
date: "2026-06-01"
format:
  html:
...
# 29. Python: Create a Timeline Plot

```{python}
import matplotlib.pyplot as plt

events = [
    ("Nine Chapters elimination", -100),
    ("Seki determinants", 1683),
    ("Leibniz determinants", 1693),
    ("Cramer's rule", 1750),
    ("Gauss least squares", 1809),
    ("Fourier heat theory", 1822),
    ("Hamilton quaternions", 1843),
    ("Grassmann extension theory", 1844),
    ("Sylvester names matrix", 1848),
    ("Cayley matrix algebra", 1858),
    ("Jordan canonical form", 1870),
    ("Schur decomposition", 1909),
    ("Haar basis", 1910),
    ("Hilbert spaces", 1920),
    ("Hotelling PCA", 1933),
...
for i, (label, year) in enumerate(events):
    ...
    plt.text(year, y, label, rotation=45, ha="right", va="center")

plt.yticks([])
plt.xlabel("Year")
plt.title("Historical Timeline of Major Linear Algebra Ideas")
plt.tight_layout()
plt.show()
```
